...
document.getElementById("nutritionForm").addEventListener("submit", function(event) {
    ...
    let foods = Array.from(document.querySelectorAll('input[name="foods"]:checked')).map(e => e.value);
    ...
    fetch("http://babynutritionchecker.infinityfreeapp.com/", {
        method: "POST",
    ...
    .then(data => {
        ...
        window.location.href = "results.html?" + new URLSearchParams(data).toString();
    })
